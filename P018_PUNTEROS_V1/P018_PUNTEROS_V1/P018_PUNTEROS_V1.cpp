// P018_PUNTEROS_V1.cpp : Este archivo contiene la función "main". La ejecución del programa comienza y termina ahí.
// Daniel Reyes C.
// Punteros
...
int main() {
    ...
    std::cout << "Ingrese el número de filas (F): ";
    std::cin >> n;
    std::cout << "Ingrese el número de columnas (C): ";
    std::cin >> m;
