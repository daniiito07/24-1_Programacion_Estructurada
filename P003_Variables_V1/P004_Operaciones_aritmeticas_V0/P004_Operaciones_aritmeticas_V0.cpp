// P004_Operaciones_aritmeticas_V0.cpp : Este archivo contiene la función "main". La ejecución del programa comienza y termina ahí.
// Daniel Reyes
...
int main()
{
    ...
    // Realizar una operacion de variables
    std::cout << "Usuario, ahoramos a realizar operaciones" <<
        std::endl;
